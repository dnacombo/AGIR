...
% return values
stats = struct;
stats.f1.name = FACTNAMES{1};
stats.f1.fstats = fA;
stats.f1.pvalue = pA;
stats.f2.name = FACTNAMES{2};
stats.f2.fstats = fB;
stats.f2.pvalue = pB;
stats.f1xf2.name = [FACTNAMES{1} 'x' FACTNAMES{2}];
stats.f1xf2.fstats = fAB;
stats.f1xf2.pvalue = pAB;
