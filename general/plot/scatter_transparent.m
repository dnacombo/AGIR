function scatterPoints = scatter_transparent(x,y,sizeOfCirlce,color,opacity)
% scatterPoints = scatter_transparent(x,y,sizeOfCirlce,opacity)
% usage example:
...
% set(scatterPoints,'FaceColor',[1,0,0]);
    ...
    scatterPoints = patch((sizeOfCirlce*sin(rep_t)+ rep_x),(sizeOfCirlce*cos(rep_t)+rep_y),color,'edgecolor','none');
