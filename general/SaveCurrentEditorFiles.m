...
%% Manipulation of the management of the shortcuts based on the version
  switch version ( '-release' )
    case { '2012b' '2013a' '2013b' '2014a' }
      awtinvoke(com.mathworks.mlwidgets.shortcuts.ShortcutUtils,'editShortcut', 'Saved Editor Sessions', 'Toolbar Shortcuts', 'Saved Editor Sessions', 'Toolbar Shortcuts', code,[],'true')
    otherwise
