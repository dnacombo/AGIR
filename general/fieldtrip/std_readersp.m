...
if ~isstruct(ALLEEG) % old calling format
    ...
    if comp < 0
        ...
        [ersp params alltimes allfreqs] = std_readfile(filebase, 'channels', -comp, 'timelimits', timelim, 'freqlimits', freqlim, 'measure',opt.datatype);
    else
...
[opt moreopts] = finputcheck( varargin, { ...
    ...
    'datatype'      'string'  { 'ersp','itc','erpim' 'timef'} 'ersp'; ...
    'subject'       'string'  []             '' }, ...
    'std_readersp', 'ignore');
