...
if ~isstr(varargin{1}) %intial settings
    ...
    % callbacks
    % ---------
    erspparams_str     = getpref(mfilename, 'erspparams_str',[ '''cycles'', [3 0.8], ''nfreqs'', 100, ''ntimesout'', 200' ]);
    specparams_str     = getpref(mfilename, 'specparams_str','''specmode'', ''fft'', ''logtrials'', ''off''');
    erpimageparams_str = getpref(mfilename,'erpimageparams_str','''nlines'', 10,''smoothing'', 10');
    ...
    % --------------------
    if os.spectra_on== 1 
        setpref(mfilename,'specparams_str',os.spec_params)
    ...
    % --------------------
    if os.erpimage_on== 1 
        setpref(mfilename,'erpimageparams_str',os.erpimage_params)
    ...
    % -----------------
    if os.ersp_on  == 1 
        setpref(mfilename,'erspparams_str',os.ersp_params)
